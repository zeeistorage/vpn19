...
if(!$session->isAdmin() OR !isset($_GET['usertoedit'])){
    ...
    if (!$functions->emailTaken($usertoedit)) { header("Location: ".$configs->homePage()); exit; }
    $form = new Form;
?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <?php if ($session->isSuperAdmin() && strtolower($usertoedit) != strtolower($session->email)){ ?>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="home">
                                        <form class="form-horizontal" method="POST" role="form" action="#">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5 col-md-5">
                                                    <p class="form-control-static"><?php echo $adminfunctions->displayDate($req_user_info['created_at']); ?></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="registeredfromip" class="col-sm-4 col-md-3 control-label">Name:</label>
                                                <div class="col-sm-4 col-md-4">
                                                    <p class="form-control-static"><?php echo $req_user_info['name']; ?></p>
                                                </div>
                                            </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="profile">
                                        <form class="form-horizontal" id="admin-edit-user" method="POST" role="form" action="includes/adminprocess.php">      
                                            ...
                                            <div class="form-group <?php if(Form::error("email")){ echo 'has-error'; } ?>">
                                                <label for="inputemail" class="col-sm-4 col-md-3 control-label">email:</label>
                                                <div class="col-sm-4 col-md-4">
                                                    <input name="email" type="text" class="form-control" id="inputemail" placeholder="email" value="<?php if(Form::value("email") == ""){ echo $req_user_info['email']; } else { echo Form::value("email"); } ?>">                            
                                                </div>
                                                <div class="col-sm-4">
                                            ...
                                            <div class="form-group <?php if(Form::error("name")){ echo 'has-error'; } ?> ">
                                                <label for="inputname" class="col-sm-4 col-md-3 control-label">Name:</label>
                                                <div class="col-sm-4 col-md-4">
                                                    <input type="text" name="name" class="form-control" id="inputname" placeholder="First Name" value="<?php if(Form::value("name") == ""){ echo $req_user_info['name']; } else { echo Form::value("name"); } ?>">                             
                                                </div>
                                                <div class="col-sm-4">
                                                    <small><?php echo Form::error("name"); ?></small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4 col-md-4">
                                                    <?php echo $adminfunctions->stopField($session->email, 'edit-user'); ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="groups">
                                        ...
                                        $sql2 = "SELECT group_id FROM users_groups WHERE unique_id = '$userid'";
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-4 col-md-3"></div>
                                            <div class="col-sm-4 col-md-4">
                                                <?php echo $adminfunctions->stopField($session->email, 'edit-groups'); ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="homepage">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-4 col-md-3"></div>
                                            <div class="col-sm-4 col-md-4">
                                                <?php echo $adminfunctions->stopField($session->email, 'update_userhome'); ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="other-admin">
                                        ...
                                        <div class="form-group"> 
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <?php echo $adminfunctions->stopField($session->email, 'delete-user'); ?>
